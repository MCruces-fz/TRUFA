...
void doStaffCalibration(char* path,char* name) {
    ...
    //unpack.setFileHitFinderParOut("../2021DST/pars/"+day+"_CalPars.txt");
    //unpack.fillCalibration(fPath,fName,"../2021DST/qcalhistos/", day+"_qhistos.root",1000000,0);
...
void doStaffAnalysis(char* path,char* name){
    ...
    //fill.setFileHitFinderPar("../2021DST/pars/"+day+"_CalPars.txt");
    //fill.fillHistograms(fPath,fName,"../2021DST/results/", day+"_result_histos.root",1000000,0);
